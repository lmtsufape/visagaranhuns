                                                ...
                                                <tr>
                                                    ...
                                                    <th class="subtituloBarraPrincipal"
                                                        ...
                                                        <button type="button"
                                                                ...
                                                                onclick="statusCNAERequisicaoEmpresa('criarRequisicao','{{$item->descricao}}',null, '{{$item->id}}', '{{$empresas->id}}')"
                                                                data-toggle="modal"
                            ...
                            <div class="form col-md-12" style="margin-top:-10px;">
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="subtituloBarraPrincipal"
                                            style="font-size:15px; color:black; font-weight:bold">Resp. Técnico
                                        </th>
                                        <th scope="col" class="subtituloBarraPrincipal"
                                    ...
                                    @foreach($requerimentos as $indice)
                                        @if ($indice->status == "reprovado")
                                            <tr>
                                                ...
                                                <th class="subtituloBarraPrincipal"
                                                    style="font-size:15px; width: 240px; color:black">{{$indice->resptecnico->user->name}}</th>
                                                ...
                                                <input type="hidden" id="teste{{$indice->id}}"
                                                       value="{{ $indice->aviso }}">
                                                <th class="subtituloBarraPrincipal"
                                                    style="font-size:15px; text-align:center; vertical-align:middle; color:black">
                                                    <button type="button" class="btn btn-primary btn-sm"
                                                            style="font-size:15px;"
                                                            onclick="avisoReq('{{$indice->id}}')" data-toggle="modal"
                                                            data-target="#exampleModalCenter">Abrir
                                                    </button>
                                                </th>
                                            </tr>
                                        @else
                                            <tr>
                                                <th class="subtituloBarraPrincipal"
                                                    style="font-size:15px; color:black">{{$indice->cnae->codigo}}</th>
                                                <th class="subtituloBarraPrincipal"
                                                    style="font-size:15px; width: 240px; color:black">{{$indice->cnae->descricao}}</th>
                                                @if ($indice->resptecnico != null)
                                                    <th class="subtituloBarraPrincipal"
                                                        style="font-size:15px; color:black">{{$indice->resptecnico->user->name}}</th>
                                                @else
                                                    <th class="subtituloBarraPrincipal"
                                                        style="font-size:15px; color:black"></th>
                                                @endif
                                                <th class="subtituloBarraPrincipal"
                                                    style="font-size:15px; color:black">{{$indice->tipo}}
                                                </th>
                                                <th class="subtituloBarraPrincipal"
                                                    style="font-size:15px; color:black">{{$indice->status}}</th>
                                                <th class="subtituloBarraPrincipal"
                                                    style="font-size:15px; color:black">{{date('d-m-Y', strtotime($indice->data))}}</th>
                                                <th class="subtituloBarraPrincipal"
                                                    style="font-size:15px; color:black">{{$indice->aviso}}</th>
                                            </tr>
                                        @endif
                                    @endforeach
                                    </tbody>
                ...
                <form id="formRequerimento" method="POST" action="{{ route('cadastrar.requerimento') }}">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-12"><textarea name="avisoRequerimentoEmpresa" id="summary-ckeditor"
                                                          cols="30" rows="10" disabled></textarea></div>
                        </div>
                    </div>
                </form>
            </div>
                    ...
                    <div class="row">
                        <div class="col-12" style="font-family: 'Roboto', sans-serif;"><label id="descricaoCNAERT"
                            ...
                            Você pode gerar um arquivo da situação documental da empresa clicando <a
                                href="{{route('gerar.situacao', ['areas' => $areas, 'empresa' => $empresas->id])}}"
                    ...
                    <div class="row">
                        <div class="col-12" style="font-family: 'Roboto', sans-serif;"><label
                            ...
                            documentos que não foram anexados! Verifique clicando <a
                                href="{{route('pagina.mostrar.documentacao', ['value' => Crypt::encrypt($empresas->id)])}}"
                                style="weight:500px;">aqui</a>.
                            Você pode gerar um arquivo da situação documental da empresa clicando <a
                                href="{{route('gerar.situacao', ['areas' => $areas, 'empresa' => $empresas->id])}}"
                                style="weight:500px;">aqui</a>.
